...
function Navbar() {
  ...
  return (
    <div className='lg:w-[22.95rem] md:w-[14rem] flex-shrink-0 rounded-r-2xl rounded-br-md shadow-2xl shadow-black/70   bg-[#001529]/[84%]'>
        <div className='flex flex-col justify-start  mt-2 divide-y divide-[#636363] '>
            ...
            <h1 onClick={()=>{localStorage.removeItem('userInfo');location.reload()}} className='text-white text-[1.689rem] hover:cursor-pointer  p-2 font-normal'>Logout</h1>
            </div>
